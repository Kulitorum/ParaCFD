...
//
// scour-gui captures the viewer's framebuffer whenever the sand bed changes and streams the frames
...
namespace scour::gui
{
	...
	public:
		...
		// Arm recording to `path` (an .mp4). ffmpeg is located (SCOUR_FFMPEG env → PATH → bundled build)
