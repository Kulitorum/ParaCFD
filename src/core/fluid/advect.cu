...
namespace scour::core
{
	namespace
	{
		...
		SCOUR_HD inline double sample_comp(int comp, const double* f, MacGrid g, BC bc, double x, double y, double z, double* mn, double* mx)
		{
		...
		SCOUR_HD inline void vel_at(const double* u, const double* v, const double* w, MacGrid g, BC bc,
		...
		SCOUR_HD inline void rk2_trace(const double* u, const double* v, const double* w, MacGrid g, BC bc, double dt,
		...
		SCOUR_HD inline bool near_wall(int comp, MacGrid g, int i, int j, int k, int band)
		{
