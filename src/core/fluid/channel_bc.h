...
namespace paracfd::core
{
	...
	PARACFD_HD inline double channel_inlet_u(ChannelBC bc, MacGrid g, int k)
	{
		double up;
	...
	PARACFD_HD inline double loglaw_ustar_for_U(double U, double H, double z0, double kappa)
	{
	...
	PARACFD_HD inline double ch_fetch_u(const double* u, MacGrid g, ChannelBC bc, int i, int j, int k)
	{
		double factor = 1.0;
	...
	PARACFD_HD inline double ch_fetch_v(const double* v, MacGrid g, ChannelBC bc, int i, int j, int k)
	{
		double factor = 1.0;
	...
	PARACFD_HD inline double ch_fetch_w(const double* w, MacGrid g, ChannelBC bc, int i, int j, int k)
	{
		double factor = 1.0;
		bool inlet_ghost = false;
		if (bc.flow_sign < 0)
	...
	PARACFD_HD inline double ch_trilerp_u(const double* u, MacGrid g, ChannelBC bc, double x, double y, double z, double* mn, double* mx)
	{
	...
	PARACFD_HD inline double ch_trilerp_v(const double* v, MacGrid g, ChannelBC bc, double x, double y, double z, double* mn, double* mx)
	{
	...
	PARACFD_HD inline double ch_trilerp_w(const double* w, MacGrid g, ChannelBC bc, double x, double y, double z, double* mn, double* mx)
	{
	...
	PARACFD_HD inline bool ch_is_solid(const unsigned char* solid, MacGrid g, int i, int j, int k)
	{
	...
	PARACFD_HD inline bool ch_usolid(const unsigned char* s, MacGrid g, int i, int j, int k)
	{ return ch_is_solid(s, g, i - 1, j, k) && ch_is_solid(s, g, i, j, k); }
	PARACFD_HD inline bool ch_vsolid(const unsigned char* s, MacGrid g, int i, int j, int k)
	{ return ch_is_solid(s, g, i, j - 1, k) && ch_is_solid(s, g, i, j, k); }
	PARACFD_HD inline bool ch_wsolid(const unsigned char* s, MacGrid g, int i, int j, int k)
