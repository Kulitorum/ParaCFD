...
namespace paracfd::core
{
		...
		const CompositeAmrPressureSystem& system,DeviceAmrFields& fields):system_(&system),fields_(&fields)
	{
		...
		x_=allocate<Real>(storage_size_,"allocate composite cell momentum x");y_=allocate<Real>(storage_size_,"allocate composite cell momentum y");z_=allocate<Real>(storage_size_,"allocate composite cell momentum z");delta_x_=allocate<Real>(storage_size_,"allocate composite cell momentum dx");delta_y_=allocate<Real>(storage_size_,"allocate composite cell momentum dy");delta_z_=allocate<Real>(storage_size_,"allocate composite cell momentum dz");volume_=upload(volume,"upload composite cell momentum volumes");active_=upload(system.active,"upload composite cell momentum active mask");cut_face_mask_=upload(system.cut_face_mask,"upload composite cell momentum cut-face mask");compact_plus_mask_=upload(compact_plus,"upload composite cell momentum compact ownership");regular_velocity_=allocate<Real>(regular_count_,"allocate composite cell momentum perimeter flux");regular_a_=upload(regular_a,"upload composite cell momentum perimeter lower nodes");regular_b_=upload(regular_b,"upload composite cell momentum perimeter upper nodes");regular_axis_=upload(regular_axis,"upload composite cell momentum perimeter axes");regular_area_=upload(regular_area,"upload composite cell momentum perimeter areas");regular_conductance_=upload(regular_conductance,"upload composite cell momentum perimeter conductances");regular_upper_weight_=upload(regular_upper_weight,"upload composite cell momentum perimeter interpolation");coarse_fine_a_=upload(coarse_fine_a,"upload composite cell momentum coarse/fine lower nodes");coarse_fine_b_=upload(coarse_fine_b,"upload composite cell momentum coarse/fine upper nodes");coarse_fine_axis_=upload(coarse_fine_axis,"upload composite cell momentum coarse/fine axes");coarse_fine_area_=upload(coarse_fine_area,"upload composite cell momentum coarse/fine areas");coarse_fine_conductance_=upload(coarse_fine_conductance,"upload composite cell momentum coarse/fine conductances");coarse_fine_upper_weight_=upload(coarse_fine_upper_weight,"upload composite cell momentum coarse/fine interpolation");embedded_a_=upload(embedded_a,"upload composite cell momentum aperture lower nodes");embedded_b_=upload(embedded_b,"upload composite cell momentum aperture upper nodes");embedded_axis_=upload(embedded_axis,"upload composite cell momentum aperture axes");embedded_area_=upload(embedded_area,"upload composite cell momentum aperture areas");embedded_conductance_=upload(embedded_conductance,"upload composite cell momentum aperture conductances");embedded_upper_weight_=upload(embedded_upper_weight,"upload composite cell momentum aperture interpolation");surface_dof_=upload(surface_dof,"upload composite cell momentum surface nodes");surface_coefficient_=upload(surface_coefficient,"upload composite cell momentum surface coefficients");bytes_=static_cast<std::size_t>(7*storage_size_+4*regular_count_+3*coarse_fine_count_+3*embedded_count_+3*surface_count_)*sizeof(Real)+static_cast<std::size_t>(3*storage_size_+regular_count_+coarse_fine_count_+embedded_count_)*sizeof(unsigned char)+static_cast<std::size_t>(2*regular_count_+2*coarse_fine_count_+2*embedded_count_+surface_count_)*sizeof(int);
	}

	DeviceCompositeCellMomentumTransport::~DeviceCompositeCellMomentumTransport()
	{
		for(void* pointer:{(void*)x_,(void*)y_,(void*)z_,(void*)delta_x_,(void*)delta_y_,(void*)delta_z_,(void*)volume_,(void*)regular_velocity_,(void*)active_,(void*)cut_face_mask_,(void*)compact_plus_mask_,(void*)coarse_fine_a_,(void*)coarse_fine_b_,(void*)coarse_fine_axis_,(void*)coarse_fine_area_,(void*)coarse_fine_conductance_,(void*)coarse_fine_upper_weight_,(void*)embedded_a_,(void*)embedded_b_,(void*)embedded_axis_,(void*)embedded_area_,(void*)embedded_conductance_,(void*)embedded_upper_weight_,(void*)regular_a_,(void*)regular_b_,(void*)regular_axis_,(void*)regular_area_,(void*)regular_conductance_,(void*)regular_upper_weight_,(void*)surface_dof_,(void*)surface_coefficient_})if(pointer)cudaFree(pointer);
	}
