...
- The new external-aero timestep is wired end to end with bounded MacCormack/RK2 advection. Fabric-near faces still use a conservative static protection fallback. Same-level brick crossings are continuous, while fully conservative coarse/fine reconstruction is still required.
