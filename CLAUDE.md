...
- A canonical-frame 500-step PlanB diagnostic with the same-side graph reaches 0.622 s. The former structured leading-edge runaway is removed: the regular peak stays near 12.1 m/s for a 10 m/s inlet. A compact EB aperture state still peaks near 46.0 m/s, and the pressure-only force remains evolving near `[132.0, -0.57, 38.1]` N. This is a stability/conservation diagnostic, not an aerodynamically validated load. Grid/force convergence, higher-order EB transport, and orientation/AoA confirmation remain necessary.
