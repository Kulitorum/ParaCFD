...
{
	std::string config_path="configs/planb_parakite.json";int steps=50,sample_every=5;double projection_tolerance=0,min_volume_fraction=0;bool locate_regular_max=false;
	for(int i=1;i<argc;++i)
	{
		...
		else{std::fprintf(stderr,"usage: paraglider_case_probe [--config file] [--steps N] [--sample-every N] [--projection-tolerance value] [--min-volume-fraction value] [--locate-regular-max]\n");return 2;}
	}
