...
int main(int argc,char** argv)
{
	...
	for(int i=1;i<argc;++i)
	{
		...
		else{std::fprintf(stderr,"usage: paraglider_case_probe [--config file] [--step file] [--steps N] [--physical-time seconds] [--sample-every N] [--projection-tolerance value] [--min-volume-fraction value] [--smagorinsky-cs value] [--max-levels N] [--half-wing] [--thin-y-fraction 0..1] [--thin-y-width metres] [--locate-regular-max] [--conservative-cell-momentum|--staggered-momentum] [--no-smooth-wall] [--no-pressure-impulse]\n");return 2;}
	}
