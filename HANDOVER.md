...
1. Apply the arbitrary-orientation Spalding fabric-wall impulse directly to the new cell/fragment-centred momentum state, retaining equal-and-opposite winding-invariant CAD traction without a MAC-to-cell smoothing round trip.
